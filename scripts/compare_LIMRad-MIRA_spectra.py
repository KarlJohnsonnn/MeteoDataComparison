...
LR_lv0 = nc.LIMRAD94_LV0(LIMRAD_path, date, time_intervall, [height-0.1, height+0.1])
LR_lv1 = nc.LIMRAD94_LV1(LIMRAD_path, date, time_intervall, [height-0.1, height+0.1])
...
MIRA_lv0 = nc2.MIRA35_spectra(MIRA_path, date, time_intervall)
...
if save_spectra_to_png:
    ...
    for bsp_height in spectra_height:
        ...
        fig, plt, ax = Plot_Doppler_Spectra_LIMRad_MIRA_sameplot(LR_lv0, ichirp, itime, iheight, [-60, 20], MIRA_lv0, mitime, miheight)
